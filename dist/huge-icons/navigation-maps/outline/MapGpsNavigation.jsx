...
const SvgMapGpsNavigation = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
    ...
    <path stroke="currentColor" strokeWidth={1.5} d="m10.763 8.92-1.515-.504a.5.5 0 0 1-.04-.934l4.643-1.99a.5.5 0 0 1 .657.657l-1.99 4.642a.5.5 0 0 1-.934-.039l-.505-1.515a.5.5 0 0 0-.316-.316Z"/>
