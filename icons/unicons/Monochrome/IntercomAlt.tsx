...
const SvgIntercomAlt = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#A2A1FF"
      d="M20 23H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v16a3.004 3.004 0 0 1-3 3"
    />
    <path
      fill="#6563FF"
