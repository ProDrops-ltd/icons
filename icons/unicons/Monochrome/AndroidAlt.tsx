...
const SvgAndroidAlt = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#6563FF"
      d="m16.2 4.7.7-1.2c.2-.5.1-1.1-.4-1.4-.5-.2-1.1-.1-1.4.4l-.6 1.1c.6.2 1.2.6 1.7 1.1m-8.4 0c.5-.5 1-.8 1.7-1.1l-.6-1.1c-.3-.5-.9-.6-1.4-.4s-.6.9-.4 1.4zM18 9H6v2h12z"
    />
    <path
      fill="#A2A1FF"
