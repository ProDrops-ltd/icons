...
const SvgFolderFavourite = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="m9.365 13.706 1.854 2.318a1 1 0 0 0 1.562 0l1.854-2.318c.236-.295.365-.662.365-1.04v-.075a1.591 1.591 0 0 0-2.716-1.125L12 11.75l-.284-.284A1.591 1.591 0 0 0 9 12.591v.075c0 .378.129.745.365 1.04"
    />
  </svg>
);
