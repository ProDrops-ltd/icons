...
const SvgTurnLeft = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="m10.396 10.75.72.72a.75.75 0 1 1-1.06 1.06l-1.293-1.293a1.75 1.75 0 0 1 0-2.474l1.293-1.293a.75.75 0 1 1 1.06 1.06l-.72.72H12A2.75 2.75 0 0 1 14.75 12v4a.75.75 0 0 1-1.5 0v-4c0-.69-.56-1.25-1.25-1.25z"
      clipRule="evenodd"
    />
  </svg>
);
