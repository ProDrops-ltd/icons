...
const SvgImageTick = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M21.45 2.4a.75.75 0 0 1 .15 1.05l-2.308 3.078a1.75 1.75 0 0 1-2.638.187L15.47 5.53a.75.75 0 0 1 1.06-1.06l1.185 1.184a.25.25 0 0 0 .377-.026L20.4 2.55a.75.75 0 0 1 1.05-.15"
      clipRule="evenodd"
    />
  </svg>
);
