...
const SvgBookDownload = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="m18.75 18.397.72-.72a.75.75 0 1 1 1.06 1.06l-1.293 1.293a1.75 1.75 0 0 1-2.474 0l-1.293-1.293a.75.75 0 1 1 1.06-1.06l.72.72v-4.19a.75.75 0 0 1 1.5 0z"
      clipRule="evenodd"
    />
  </svg>
);
