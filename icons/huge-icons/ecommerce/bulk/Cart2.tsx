...
const SvgCart2 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M17.653 11.632a.75.75 0 0 1-.285 1.021c-1.215.686-2.262 1.095-3.365 1.097-1.105.002-2.154-.404-3.374-1.098a.75.75 0 0 1 .742-1.304c1.136.647 1.911.903 2.629.902.719-.001 1.494-.262 2.631-.903a.75.75 0 0 1 1.022.285"
      clipRule="evenodd"
    />
  </svg>
);
