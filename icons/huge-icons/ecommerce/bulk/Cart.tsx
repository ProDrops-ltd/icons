...
const SvgCart = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M2 2a.75.75 0 0 1 .75-.75h2A2.75 2.75 0 0 1 7.5 4v1A.75.75 0 0 1 6 5V4c0-.69-.56-1.25-1.25-1.25h-2A.75.75 0 0 1 2 2"
      clipRule="evenodd"
      opacity={0.4}
    />
    <path
    ...
    <path fill="currentColor" d="M18 4H6v4h16a4 4 0 0 0-4-4" />
  </svg>
);
