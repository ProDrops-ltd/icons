...
const SvgBrightness = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M12 2a.75.75 0 0 1 .75.75v1a.75.75 0 1 1-1.5 0v-1A.75.75 0 0 1 12 2m6 10a6 6 0 1 1-12 0 6 6 0 0 1 12 0m-5.25 8.25a.75.75 0 1 0-1.5 0v1a.75.75 0 0 0 1.5 0zM3.34 7a.75.75 0 0 1 1.024-.274l.866.5a.75.75 0 1 1-.75 1.299l-.866-.5A.75.75 0 0 1 3.34 7m16.18 8.476a.75.75 0 0 0-.75 1.298l.866.5a.75.75 0 0 0 .75-1.299zM20.66 7a.75.75 0 0 1-.274 1.024l-.866.5a.75.75 0 0 1-.75-1.299l.866-.5A.75.75 0 0 1 20.66 7M5.23 16.775a.75.75 0 1 0-.75-1.3l-.866.5a.75.75 0 1 0 .75 1.3z"
      clipRule="evenodd"
    />
  </svg>
);
