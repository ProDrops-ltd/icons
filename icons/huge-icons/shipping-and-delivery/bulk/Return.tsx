...
const SvgReturn = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M7.325 1.674A.75.75 0 0 1 8 1.25h6.5a2.25 2.25 0 0 1 0 4.5H13a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 0 0-1.5H9.552l.622.784a.75.75 0 1 1-1.176.932l-1.586-2a.75.75 0 0 1-.087-.792"
      clipRule="evenodd"
    />
  </svg>
);
