...
const SvgHealthCare = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M16.459 2.946 16 3.402l-.459-.456a3.26 3.26 0 0 0-4.59 0 3.217 3.217 0 0 0 0 4.566l4.13 4.11c.508.504 1.33.504 1.837 0l4.131-4.11a3.217 3.217 0 0 0 0-4.566 3.26 3.26 0 0 0-4.59 0Z"
    />
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M2 10h2l6.262 2.74a1.91 1.91 0 0 1 .99 2.503v0a1.91 1.91 0 0 1-2.509 1.004L7 15.5"
    />
    <path
      fill="currentColor"
