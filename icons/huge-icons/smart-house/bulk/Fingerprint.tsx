...
const SvgFingerprint = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M13 9.25a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
      opacity={0.4}
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M13 7.75A2.25 2.25 0 0 0 10.75 10v2.657c0 1.7-.675 3.329-1.877 4.53l-.343.343a.75.75 0 0 1-1.06-1.06l.343-.343a4.9 4.9 0 0 0 1.437-3.47V10a3.75 3.75 0 1 1 7.5 0v2.657c0 1.7-.675 3.329-1.876 4.53l-.344.343a.75.75 0 1 1-1.06-1.06l.343-.343a4.9 4.9 0 0 0 1.437-3.47V10A2.25 2.25 0 0 0 13 7.75"
      clipRule="evenodd"
      opacity={0.4}
    />
  </svg>
