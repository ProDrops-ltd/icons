...
const SvgEyeScanner = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M12 17c3.078 0 5.75-2.427 7.088-3.899a1.62 1.62 0 0 0 0-2.202C17.75 9.426 15.078 7 12 7s-5.75 2.426-7.088 3.899a1.62 1.62 0 0 0 0 2.202C6.25 14.573 8.922 17 12 17m0-3a2 2 0 1 0 0-4 2 2 0 0 0 0 4"
      clipRule="evenodd"
      opacity={0.4}
    />
    <path
