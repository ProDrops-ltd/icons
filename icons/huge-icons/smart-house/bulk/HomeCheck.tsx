...
const SvgHomeCheck = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M16.416 10.376a.75.75 0 0 1 .208 1.04l-2.647 3.97a2.75 2.75 0 0 1-4.232.42L8.47 14.53a.75.75 0 0 1 1.06-1.06l1.275 1.275a1.25 1.25 0 0 0 1.924-.19l2.647-3.97a.75.75 0 0 1 1.04-.209"
      clipRule="evenodd"
    />
  </svg>
);
