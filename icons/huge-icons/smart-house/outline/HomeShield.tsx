...
const SvgHomeShield = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m11.106 9.447-2 1c-.678.339-1.115 1.033-1.078 1.79.147 3.034.902 4.412 2.859 5.95a1.8 1.8 0 0 0 2.226 0c1.962-1.548 2.69-2.943 2.851-5.94.041-.762-.396-1.463-1.079-1.804l-1.99-.996a2 2 0 0 0-1.79 0Z"
    />
  </svg>
);
